package com.rspace.domain.aop;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.rspace.db.entity.Session;
import com.rspace.domain.annotation.CheckToken;
import com.rspace.domain.constant.ErrorCode;
import com.rspace.domain.constant.RedisOption;
import com.rspace.domain.constant.RoleType;
import com.rspace.domain.exception.ServiceException;
import com.rspace.domain.util.CurrentRequestHolder;
import com.rspace.domain.util.HttpRequestUtil;
import com.rspace.domain.util.JacksonUtil;
import com.rspace.domain.util.RedisUtil;
...
public class CheckTokenAspect {
    ...
    @Pointcut("@within(com.rspace.domain.annotation.CheckToken)")
